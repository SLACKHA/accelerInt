...
__device__ void get_rxn_pres_mod (const Real T, const Real pres, const Real * C, Real * pres_mod) {
  ...
  pres_mod[6] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[7] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[12] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[13] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[14] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[15] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[16] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[17] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[18] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[19] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[20] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[21] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[22] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[23] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[24] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[26] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[34] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[36] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[37] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[38] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[39] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
  ...
  A = log10(fmax(Pr, 1.0e-300)) - 0.67 * logFcent - 0.4;
  B = 0.806 - 1.1762 * logFcent - 0.14 * log10(fmax(Pr, 1.0e-300));
  pres_mod[40] = exp10(logFcent / (1.0 + A * A / (B * B))) * Pr / (1.0 + Pr);
