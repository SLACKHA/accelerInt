...
\end{DoxySeeAlso}
\index{exp4cu@{exp4cu}!create\+And\+Zero@{create\+And\+Zero}}
...
/fn void \hyperlink{namespaceexp4cu_abcdabb48b002afcaf4520f85bb06c156}{create\+And\+Zero(void$\ast$$\ast$ ptr, size\+\_\+t size)} /brief Convienvience method to Cuda Malloc and memset a pointer to zero /param ptr The address of the pointer to malloc /param size The total size (in bytes) of the pointer to malloc \index{exp4cu@{exp4cu}!init\+\_\+solver\+\_\+log@{init\+\_\+solver\+\_\+log}}
...
Solves for the poles and residuals used for the Rational Approximants in the Krylov subspace methods and initializes \hyperlink{structexp4cu_1_1solver__memory}{solver\+\_\+memory}. 
...
\hline
\end{DoxyParams}
\index{exp4cu@{exp4cu}!integrate@{integrate}}
