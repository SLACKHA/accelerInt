...
\item 
static int \hyperlink{arnoldi_8h_a8b64f0d02450612b167702a2ff72fd90}{arnoldi} (const double \hyperlink{radau2a_8cu_a4fab5866449108992478041d2e51a28c}{scale}, const int p, const double h, const double $\ast$A, const double $\ast$v, const double $\ast$sc, double $\ast$beta, double $\ast$Vm, double $\ast$Hm, double $\ast$phi\+Hm)
